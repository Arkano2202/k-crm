...
if (isset($_GET['busqueda']) && !empty($_GET['busqueda'])) {
    ...
    $where_conditions[] = "(Nombre LIKE :busqueda OR Apellido LIKE :busqueda OR Correo LIKE :busqueda OR Numero LIKE :busqueda)";
                ...
                <form id="filtersForm" method="GET" action="eliminar.php">
                    ...
                    <div class="filter-section">
                        ...
                        <small style="color: #7f8c8d; font-size: 12px; margin-top: 5px; display: block;">
                            Busca en nombre, teléfono y correo electrónico
                        </small>
                    </div>
