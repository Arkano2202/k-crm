...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $user_query = "SELECT usuario FROM users WHERE usuario = :usuario_login";
        ...
        // Insertar cita
        $query = "INSERT INTO citas (titulo, descripcion, fecha, hora, usuario_id) 
                  VALUES (:titulo, :descripcion, :fecha, :hora, :usuario_login)";
